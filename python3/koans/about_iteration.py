...
class AboutIteration(Koan):
    ...
    def test_reduce_will_blow_your_mind(self):
        ...
        # operates on the first 2 elements of sequence (e.g list), and then taking that result
        # and the next item in sequence, performs the operations again, and then
        # repeats until you complete sequence resulting in single value
